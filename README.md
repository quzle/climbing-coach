...
An AI-powered climbing training assistant for an experienced boulderer and multipitch sport climber targeting 7a–7b onsight on limestone and granite. Built with Next.js, Supabase (Postgres), and Google Gemini AI. Single-user application deployed on Vercel.
