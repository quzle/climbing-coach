 ...
 * the same name already exists it is reactivated rather than duplicated.
 *
...
export async function addInjuryArea(
  ...
  try {
    ...
    // without creating a duplicate row (area has a UNIQUE constraint).
