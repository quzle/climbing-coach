...
describe('plannedSessionRepository', () => {
  ...
  it('getPlannedSessionsInRange returns planned sessions ordered by date', async () => {
    ...
    const result = await getPlannedSessionsInRange('user-1', '2026-03-25', '2026-03-31')
  ...
  it('getUpcomingPlannedSessions fetches future sessions using a date range', async () => {
    ...
    const result = await getUpcomingPlannedSessions('user-1', 7)
  ...
  it('getPlannedSessionById returns a single planned session', async () => {
    ...
    const result = await getPlannedSessionById('user-1', 'planned-session-1')
  ...
  it('createPlannedSession inserts and returns the created row', async () => {
    ...
    const result = await createPlannedSession('user-1', input)
  ...
  it('updatePlannedSession updates and returns the row', async () => {
    ...
    const result = await updatePlannedSession('user-1', 'planned-session-1', updates)
  ...
  it('deletePlannedSession deletes and returns the row', async () => {
    ...
    const result = await deletePlannedSession('user-1', 'planned-session-1')
